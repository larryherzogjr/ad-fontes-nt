...
subhead: "The Calling You Already Have"
gloss: "calling"
volume: 1
access: "free"
slug: "klesis"
description: "Klēsis (κλῆσις), \"calling\" — a New Testament Greek word study: meaning, range, where you meet it in Scripture, and what confessional Lutherans hear."
draft: false
category: "The Christian Life"
tags: ["vocation", "church-ministry"]
...
This is the entry on *klēsis*. The Lutheran tradition has read this language with a distinctive emphasis that the medieval church had largely lost and that modern American Christianity has largely forgotten — the doctrine that every legitimate work is a calling from God, that the cobbler at his bench and the mother changing diapers and the magistrate enforcing the law and the pastor preaching the gospel are all in vocation, called by God, serving their neighbors, doing the work He has given them in the station where He has placed them. The calling you already have is, on this reading, plenty.

## The Word

**κλῆσις** (klēsis), pronounced *KLAY-sis*. A feminine noun. The root is the verb *kaleō* (καλέω), “to call, to summon, to invite, to name.” The family is large and theologically important: *kaleō* (the verb, to call), *klēsis* (the noun, calling), *klētos* (κλητός, the verbal adjective, “called” — applied frequently in the New Testament as a near-synonym for “Christian”), and the great compound *ekklēsia* (ἐκκλησία, built from *ek* + *kaleō* — an etymology often mispreached as “called-out ones,” though in first-century usage it simply meant “assembly”; the New Testament’s standard word for the church, treated in [Ekklēsia](/greek/ekklesia/)).
...
The Septuagint background is worth knowing. In the Old Testament, God *calls* — He calls Abraham out of Ur (Gen 12:1, *kaleō* in LXX); He calls Israel out of Egypt (Hos 11:1); He calls prophets to particular missions (Isa 6:8 and the prophetic call narratives generally); He calls by name those who are His (Isa 43:1, “I call you by name, you are mine.”). The Hebrew verb *qara* (“to call”) is the standard equivalent. The pattern is consistent: God calls; the called respond; the response shapes their life into a new form because the One who called them has named them as His own.
...
- The general call of the gospel, addressed to all who hear. “Many are called, but few are chosen” (Matt 22:14, NET).
- The effective call of the Spirit, which creates faith in the believer. Romans 8:30 — “And those he predestined, he also called; and those he called, he also justified; and those he justified, he also glorified.”
...
- The collective calling of the church as *ekklēsia* — the assembled community (not “called-out ones”; see [Ekklēsia](/greek/ekklesia/) for why that etymology cannot bear the weight). Romans 1:6–7, 1 Corinthians 1:2.
...
> “Nevertheless, as the Lord has assigned to each one, as God has called each person, so must he live. I give this sort of direction in all the churches. … In whatever situation someone was called, brothers and sisters, let him remain in it with God.” (1 Corinthians 7:17, 24, NET)

The most concentrated New Testament text on the calling-in-station sense. Paul’s context is specific (questions about marriage, slavery, circumcision in the Corinthian congregation), but the principle he articulates is general: the calling is the station God has placed you in. Not what you wish you were doing. Not what you might do someday. The calling is *here*. The verb “remain” (*menetō*) appears repeatedly in the entry. Paul’s pastoral instinct is consistent: let each one remain in the station in which he was called, and serve God there.
...
The eschatological dimension. The “upward call” — *anō klēseōs* — draws the believer toward final salvation. Paul has been speaking of “Forgetting the things that are behind and reaching out for the things that are ahead” (v. 13). The calling has direction; the direction is up; the destination is Christ. This dimension of *klēsis* names not the present station but the eschatological goal toward which all callings move. The Christian’s daily faithfulness in particular vocations is oriented by this upward calling.
...
The author of Hebrews. The believers are “partners in a heavenly calling” — *klēseōs epouraniou metochoi*. The calling is heavenly in origin (from God in heaven) and heavenly in destination (toward eternal life). The believer’s present life is lived in light of this heavenly calling. The encouragement is to “consider Jesus” — to keep the eyes fixed on the One who has called and the One toward whom the calling moves.
...
The Lutheran accent on *klēsis* falls in two places the broader Christian conversation has often softened — and that the Lutheran tradition has held distinctively for nearly five centuries.
...
The first is the two-tier system, in either its medieval Catholic form or its modern Protestant residue. Treating “religious” work (ministry, missions) as higher calling than ordinary work. The Lutheran response: all legitimate vocation is calling; the cobbler’s bench and the missionary’s pulpit are equally divine callings; the believer who treats ordinary work as second-tier has misread the New Testament’s actual theology of vocation.

The second is the “find your calling” reduction — treating calling as a particular career or path to be discovered through introspection, personal interest inventories, spiritual-gift assessments, or extended seasons of searching. The Lutheran response: you already have callings; the stations God has placed you in are the calling; faithfulness in present circumstances is the appropriate Christian posture; God’s providence (not the believer’s introspection) is what arranges the particulars of where the Christian serves.

The third is the mystical inner-voice calling. Claims of personal calling that bypass external confirmation — “God has called me to X” where X has no external confirmation in gifts, opportunities, providence, or the church’s consent. The Lutheran response: the calling comes through external means — through the Word, through providence, through the community of the church. Claims of calling that float free of these external confirmations should be tested rather than simply accepted. The Spirit who calls does so consistently with the means He has appointed.

A fourth pattern worth noting: disconnecting calling from neighbor-service. Some popular treatments make calling primarily about self-fulfillment, personal meaning, or the believer’s flourishing. The Lutheran response: vocation is for neighbor-service. The cobbler’s shoes serve his customers; the parent’s care serves the child; the worker’s labor serves the community; the citizen’s votes serve the common good. Where a “calling” has lost the orientation toward neighbor, it has drifted from the New Testament’s actual vocation theology.

## So What

You have callings already. As parent, as child, as worker, as citizen, as church member, as neighbor, as friend. Each is the place God has put you. Each is where you serve neighbor. Each is the Christian’s response to the gospel that has called you to fellowship with Christ. The “upward call” of the gospel (Phil 3:14) is one calling; the stations of daily life are other callings; all are gifts; all are real; all are where the Spirit grows fruit through you for the service of others.

For Sunday school teachers and Bible study leaders: when you teach a passage on calling, help your students see the breadth. Many will have absorbed the assumption that “calling” means a particular career or path or a higher tier of spiritual life. Help them see that their families, their work, their neighborhoods, their citizenship are all stations where God has placed them for the service of neighbor. The cobbler at his bench is not less in vocation than the missionary; the mother changing diapers is not less in vocation than the pastor preaching. The doctrine of vocation undoes the two-tier system the medieval church developed and that modern Christian culture has subtly reinstalled in new forms. Let your students see what the Lutheran tradition has held for five centuries — that ordinary life, lived in faith, is the place of Christian vocation.

For yourself: when you wonder whether you are “doing God’s will” with your life, look around. Where has God placed you? In what relationships? In what work? In what neighborhood? In what congregation? These are your callings. Be faithful in them. Love your neighbor in them. Receive Christ’s love in the means of grace and let it overflow into the stations where you find yourself. The Spirit is doing His work in the ordinary, in the daily, in the seemingly small. The calling is not elsewhere. The calling is here. The God who has called you to fellowship with Christ has also called you to the kitchen, the workshop, the polling booth, the family dinner table, the Sunday service. Each is real calling. Each is your response. Each is where the Spirit grows what the gospel has begun.

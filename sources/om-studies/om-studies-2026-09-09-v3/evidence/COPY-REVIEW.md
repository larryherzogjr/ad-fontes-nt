...
## Greek standalone editorial revision — September 9, 2026

Larry reviewed the complete standalone editorial revision and approved all changed passages on September 9, 2026, explicitly requesting updates to larryherzogjr.com and the Ad Fontes website and desktop apps. All 107 revised articles now record current approval; their prose is identical to the reviewed candidate. The other 143 articles retain their prior approvals.

The [review packet](output/editorial/greek-standalone-2026-09-09/review.md) indexes every revised article. The [approval record](output/editorial/greek-standalone-2026-09-09/APPROVAL.md) and [approval hashes](output/editorial/greek-standalone-2026-09-09/approval.json) bind this decision to the final source. The original pending-review manifest remains historical evidence, superseded by this approval.

## Original Greek article approval — September 8, 2026

Larry confirmed: “These should ALL be considered to have already been reviewed and given the green light. You can use them all (and they all should be live on the website (larryherzogjr.com) as well).”

All 250 Greek Word Explorer articles are approved for publication and use in the Ad Fontes NT website and desktop application. This supersedes the pending-author-review flags for the additional 39 articles and any historical draft annotations for the Greek collection. The Explorer landing page retains its previously approved status. Source metadata now records approval; historical adaptation comments are labeled accordingly. No article prose was changed in this approval reconciliation. Historical batch records below remain for provenance and do not reopen approval questions.

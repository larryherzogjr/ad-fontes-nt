...
This chapter has named *mathētēs* — the believer’s identity as one being formed by all the means Part IV has developed. The next (*ergon*) treats the works that flow from discipleship — the Christian’s labor and vocation; the disciple is formed not in isolation but for service.
...
[^jeg-2-156]: See Chapter 21 of this volume (graphē), Chapter 22 (rhēma), Chapter 23 (didaskalia), Chapter 24 (paradosis), and Chapter 25 (eulogeō) for the means by which disciples are formed. See Chapter 27 (ergon) for the works that flow from discipleship. See Volume One Chapter 26 (homologeō) for confession, the disciple’s public profession; Volume One Chapter 40 (klēsis) for the calling that constitutes discipleship.

...
The first is the etymological fallacy with which this chapter opened — “*ekklēsia* means called-out ones.” The Lutheran response: the active meaning is *assembly*; the etymology has faded from active sense; the careful reader does not build doctrine on etymological elements that the word no longer carries.
...
This opens Part VI. The chapters ahead will treat the offices of the church — *presbyteros* (elder, Ch 45), *episkopos* (overseer or bishop, Ch 46), and *diakonos* (deacon or servant, Ch 47). These offices serve the *ekklēsia*. They do not constitute it. The church is the assembly, gathered around Christ’s Word and table. The offices exist to serve the assembly by ensuring that the Word is preached purely and the sacraments are administered rightly. Where the assembly is, there must be the offices; where the offices serve the gospel faithfully, there is the assembly’s life and growth.

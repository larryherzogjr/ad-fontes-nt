---
title: "Klēronomos (κληρονόμος)"
linkTitle: "Klēronomos"
greek: "κληρονόμος"
translit: "Klēronomos"
pronunciation: "klay-ro-NO-mos"
subhead: "Heir"
gloss: "heir"
volume: 2
access: "free"
slug: "kleronomos"
description: "Klēronomos (κληρονόμος), \"heir\" — a New Testament Greek word study: meaning, range, where you'll meet it in Scripture, and what confessional Lutherans hear."
draft: false
category: "Grace and Justification"
tags: ["last-things", "promise"]
...
Paul offers a striking observation about heirs. “What I am saying is that as long as the heir is a child, he is no different from a slave, although he is the owner of everything” (Galatians 4:1, BSB).
...
This entry is about that word — *klēronomos* — and about the believer's identity and status as heir of God and joint-heir with Christ. Related entries treat the resurrection ([Anastasis](/greek/anastasis/)), the judgment ([Krisis](/greek/krisis/)), and the judgment seat ([Bēma](/greek/bema/)); this entry turns to the positive destiny that awaits the believer beyond the judgment — the inheritance the believer will enter as heir.
...
*Klēronomos* (κληρονόμος) — heir. The entry's main word.

*Klēronomia* (κληρονομία) — inheritance. The noun for the inheritance itself. Treated extensively in [Klēronomia](/greek/kleronomia/). Used fourteen times in the New Testament.
...
The Septuagint and Old Testament background of *klēronomos* is foundational. The LXX uses the *klēronom-* vocabulary to translate the Hebrew inheritance vocabulary, primarily *nachalah*, "inheritance, possession," and the cognate verb *nachal*, "to inherit, to take possession." The Hebrew inheritance tradition is rich and theologically substantial.
...
*God Himself as the ultimate inheritance.* Beyond the land, the deepest dimension of the Hebrew inheritance tradition is that God Himself is the inheritance of His people. Psalm 16:5-6 — “The LORD is my chosen portion and my cup; You have made my lot secure. The lines of my boundary have fallen in pleasant places; surely my inheritance is delightful.” Psalm 73:26 — “My flesh and my heart may fail, but God is the strength of my heart and my portion forever.” The BSB expresses the Hebrew portion imagery in terms of stability and security; the inheritance connection concerns the underlying Hebrew vocabulary. Lamentations 3:24 — “‘The LORD is my portion,’ says my soul, ‘therefore I will hope in Him.’” The believer's ultimate inheritance is not a thing but God Himself.

*The eschatological inheritance.* The prophetic and wisdom traditions develop the hope of an inheritance that extends beyond the present age. Daniel 12:13 — “‘But as for you, go on your way until the end. You will rest, and then you will arise to your inheritance at the end of the days.’” The inheritance is oriented toward the eschatological consummation.

Several Old Testament passages illuminate the New Testament's development:

*Genesis 15:7-8* — “The LORD also told him, ‘I am the LORD, who brought you out of Ur of the Chaldeans to give you this land to possess.’ But Abram replied, ‘Lord GOD, how can I know that I will possess it’” The promise of the land-inheritance to Abraham.

*Psalm 2:8* — "Ask Me, and I will make the nations Your inheritance, the ends of the earth Your possession." The messianic psalm in which the Son receives the nations as His inheritance — feeding into the New Testament's portrayal of Christ as the heir of all things.

*Psalm 16:5-6* — "The LORD is my chosen portion and my cup; You have made my lot secure. The lines of my boundary have fallen in pleasant places; surely my inheritance is delightful." God Himself as the inheritance.

*Psalm 37:11* — "But the meek will inherit the land and delight in abundant prosperity." The text Jesus echoes in the Beatitudes (Matthew 5:5).

The Hebrew inheritance tradition is the foundation on which the New Testament builds. The land-inheritance points toward the greater inheritance of the kingdom and the new creation. The inalienability of the inheritance points toward the security of the believer's inheritance (“reserved in heaven for you” 1 Peter 1:4). And the deepest Hebrew insight — that God Himself is the inheritance — finds its fulfillment in the believer's inheritance of God Himself, the believer's eternal communion with the Triune God in the new creation. The New Testament's *klēronomos* doctrine inherits this whole tradition and develops it Christologically.
...
*Christ as the heir of all things.* Hebrews 1:2 — “but in these last days He has spoken to us by His Son, whom He appointed heir of all things, and through whom He made the universe.” Christ is the supreme heir; all things are His inheritance. The believers' inheritance is grounded in and derived from Christ's inheritance.
...
First, the heir-as-child image. The heir, while a child, is "no different from a slave, although he is the owner of everything." The legal entitlement is real (the child owns everything) but the practical possession is not yet (the child lives under guardians). This is the image that opened the entry — the believer as the heir who already owns everything in principle but does not yet possess it in practice.

Second, the application to salvation history. Paul applies the image to the transition from the old covenant (childhood, under the guardianship of the law) to the new covenant (full sonship, in Christ). “when the time had fully come, God sent His Son … that we might receive our adoption as sons.” The history of salvation is the history of God bringing His people from the childhood of the law to the maturity of sonship in Christ.
...
*1 Peter 1:3-5.* "Blessed be the God and Father of our Lord Jesus Christ! By His great mercy He has given us new birth into a living hope through the resurrection of Jesus Christ from the dead, and into an inheritance that is imperishable, undefiled, and unfading, reserved in heaven for you, who through faith are shielded by God’s power for the salvation that is ready to be revealed in the last time." The Greek of verse 4: *eis klēronomian aphtharton kai amianton kai amaranton, tetērēmenēn en ouranois eis hymas*.

The passage develops the security of the believer's inheritance. The *klēronomia* (inheritance) was developed in [Klēronomia](/greek/kleronomia/); here we note its bearing on the believer as *klēronomos* (heir). Several observations matter.

First, the threefold description of the inheritance. *Aphtharton kai amianton kai amaranton* — "imperishable, undefiled, and unfading, reserved in heaven for you, who through faith are shielded by God’s power for the salvation that is ready to be revealed in the last time." The inheritance is not subject to decay, defilement, or fading. Unlike earthly inheritances (which can be lost, spent, corrupted, or destroyed), the believer's inheritance is permanent, pure, and ever-fresh. The three negated adjectives emphasize the contrast with everything in the present age that perishes, is defiled, and fades.

Second, the inheritance “reserved in heaven for you” *Tetērēmenēn en ouranois eis hymas* — “reserved in heaven for you, who through faith are shielded by God’s power for the salvation that is ready to be revealed in the last time.” The inheritance is being guarded, secured, reserved in heaven for the believers. The believer's inheritance is not at risk; it is kept safe by God Himself. The "already/not yet" structure appears: the inheritance is real and secure (already kept for the believer) but is not yet possessed (kept in heaven, to be revealed in the last time).

Third, the believer being guarded for the inheritance. The believer is “by God’s power for the salvation that is ready to be revealed in the last time.” Just as the inheritance is kept for the believer, the believer is kept for the inheritance. The mutual keeping — the inheritance kept for the heir, the heir kept for the inheritance — grounds the security of the believer's hope. God guards both the inheritance and the heir until the day of full possession.

*Ephesians 1:13-14.* "And in Him, having heard and believed the word of truth—the gospel of your salvation—you were sealed with the promised Holy Spirit, who is the pledge of our inheritance until the redemption of those who are God’s possession, to the praise of His glory." The Greek of verse 14: *ho estin arrabōn tēs klēronomias hēmōn*.
...
*Hebrews 1:1-4.* "On many past occasions and in many different ways, God spoke to our fathers through the prophets. But in these last days He has spoken to us by His Son, whom He appointed heir of all things, and through whom He made the universe. The Son is the radiance of God’s glory and the exact representation of His nature, upholding all things by His powerful word. After He had provided purification for sins, He sat down at the right hand of the Majesty on high. So He became as far superior to the angels as the name He has inherited is excellent beyond theirs." The Greek of verse 2: *hon ethēken klēronomon pantōn*.

The passage establishes Christ as the heir of all things. Several observations matter.

First, the appointment as heir of all things. *Hon ethēken klēronomon pantōn* — “whom He appointed heir of all things, and through whom He made the universe.” Christ is the supreme heir; all things are His inheritance. This grounds the believers' inheritance. The believers are joint-heirs with Christ (Romans 8:17); they share in the inheritance that belongs to Christ as the heir of all things. The believers' inheritance is not separate from Christ's; the believers inherit by sharing in Christ's inheritance.

Second, the connection to creation. Christ is the heir of all things and also the one “through whom He made the universe.” Christ is both the agent of creation and the heir of creation. The world that was made through Him is the world He inherits. The believers, as joint-heirs with Christ, share in the inheritance of the renewed creation (developed in [Kainē Ktisis](/greek/kaine-ktisis/)).
...
*The reduction of the inheritance to earthly prosperity.* Some Christianity, especially the prosperity gospel, has effectively reduced the believer’s inheritance to material blessings in the present age — health, wealth, success. The biblical inheritance is different. The believer’s inheritance is “and into an inheritance that is imperishable, undefiled, and unfading, reserved in heaven for you,” (1 Peter 1:4, BSB). The inheritance is the kingdom, eternal life, the new creation, communion with God — not earthly prosperity. The prosperity reduction misdirects the believer’s hope toward the present age, when the inheritance is fundamentally eschatological.

*The works-righteousness reduction that makes the inheritance earned.* Some Christianity has effectively made the inheritance something the believer earns by his works. The biblical pattern refuses this. An inheritance is received by virtue of relationship, not earned by labor. The believer is an heir because he is an adopted child of God; the inheritance follows from the adoption, which is grace. The works-righteousness reduction misunderstands the nature of inheritance.

*The over-realized eschatology that claims full possession now.* Some Christianity has effectively collapsed the “not yet” into the “already” — claiming that the believer can possess the full inheritance now, in the present age. The biblical pattern maintains the “not yet.” The believer is already an heir but does not yet possess the full inheritance. The full inheritance — the resurrection body, the kingdom, the new creation — awaits the consummation. The over-realized eschatology promises now what is reserved for the consummation, producing disillusionment when the present age fails to deliver.

*The under-realized eschatology that treats the inheritance as merely future.* The opposite error. Some Christianity has effectively reduced the inheritance to a purely future hope with no present dimension. The biblical pattern includes the present dimension. The believer is already an heir; the Spirit is already given as the guarantee; the believer already has the down payment of the inheritance. The “already” is real, even as the “not yet” awaits. The under-realized eschatology loses the present assurance and the present foretaste of the inheritance.

*The neglect of the joint-heirship with Christ.* Some Christianity has treated the believer’s inheritance as a separate possession rather than a sharing in Christ’s inheritance. The biblical pattern grounds the believer’s inheritance in Christ’s. The believer is a joint-heir with Christ (Romans 8:17), sharing in the inheritance that belongs to Christ as the heir of all things. The believer’s inheritance is not separate from Christ’s; it is grounded in union with Christ. The neglect of the joint-heirship loses the security that comes from grounding the believer’s inheritance in Christ’s.

*The reduction of the inheritance to* *“**going to heaven.**”* Some Christianity has reduced the believer’s inheritance to the disembodied soul going to heaven (the same reduction addressed in [Anastasis](/greek/anastasis/) on the resurrection). The biblical inheritance is richer. The believer’s inheritance includes the resurrection body, the renewed creation, the kingdom, eternal embodied life in the presence of God. The inheritance is not the escape of the soul to heaven but the full redemption of the believer, body and soul, in the renewed creation.

*The forgetting that God Himself is the ultimate inheritance.* The deepest Hebrew insight — that God Himself is the inheritance of His people (Psalm 16:5, 73:26) — is sometimes lost in a focus on the inheritance as a collection of blessings or possessions. The biblical inheritance, at its deepest, is God Himself. The believer’s ultimate inheritance is not merely the kingdom or the new creation as places or possessions; the believer’s ultimate inheritance is the unmediated communion with the Triune God in the new creation. To inherit the kingdom is, finally, to inherit God Himself.

*The suffering-denial that disconnects the inheritance from the cross.* Some Christianity, especially the triumphalist streams, has effectively disconnected the inheritance from the path of suffering. The biblical pattern connects them. The joint-heirs with Christ suffer with Him in order to be glorified with Him (Romans 8:17). The path to the inheritance runs through suffering, following the way of the cross before the crown. The suffering-denial promises the inheritance without the cross, departing from the biblical pattern of the joint-heirs following Christ through suffering to glory.

## So What

The Sunday school teacher angle is direct: teach the believer’s identity as heir. An inheritance is received by virtue of relationship, not earned by labor: an heir inherits because of who he is — a son or daughter — not because of what he has done. This connects directly to grace. The believer is an heir of God because he is an adopted child of God ([Huiothesia](/greek/huiothesia/)); the inheritance follows from the adoption, and the whole structure is grace. And the believer is not just an heir of God but a joint-heir with Christ (Romans 8:17), sharing in Christ’s inheritance — the inheritance that belongs to Him as the heir of all things (Hebrews 1:2). This gives your students a secure foundation for their hope: the believer’s inheritance is as secure as Christ’s; what belongs to Christ as the heir of all things, the believers share as joint-heirs, and the inheritance cannot be lost because it is grounded in Christ’s inheritance, which is secure.

For Bible study leaders, the application extends to the “already/not yet” structure in Galatians 4:1-7 and Ephesians 1:13-14. The believer is the heir who, while a child, owns everything in principle but does not yet possess it in practice (Galatians 4:1): already an heir, but not yet in full possession. The Spirit is the *arrabōn* — the down payment, the guarantee — of the inheritance (Ephesians 1:14): the believer already has the guarantee but awaits the full possession. This eschatological framework shapes the Christian life and helps students understand their present existence — why they suffer even though they are heirs, why they wait even though the inheritance is secure, why they hold the present age loosely even though they already have the down payment.

For pastoral application, the doctrine meets three concerns. When the believer is troubled about whether he will receive the inheritance: the grounding in adoption comforts — the inheritance follows from the adoption, which is grace, sealed in baptism and witnessed by the Spirit; his inheritance is as secure as Christ’s finished work. When he is suffering in the present age: the joint-heirship frames it — the path to the inheritance runs through suffering, and the joint-heirs follow their elder brother Christ through suffering to glory; the present suffering does not negate the inheritance but is the path to it. When he is impatient for the fulfillment: the “already/not yet” structure orients him — he is already an heir but does not yet possess the full inheritance; the Spirit is the guarantee, the inheritance is kept in heaven, and he waits in hope, sustained by the Spirit.

This entry has named *klēronomos* — the believer as heir of God and joint-heir with Christ. The related entry on [Basileia](/greek/basileia/) names the kingdom — one of the central dimensions of the inheritance the believer receives.

The Shepherd who laid down His life for the sheep is the heir of all things, and the sheep, united to Him, are joint-heirs with Him — sharing in His inheritance, destined to receive what belongs to Him. They are already heirs, marked with the Spirit as the guarantee, with the inheritance kept safe in heaven. They wait in the present age, following the Shepherd through suffering toward glory, anticipating the day of full possession — when they will enter the inheritance that has been theirs all along in Christ: the kingdom, the new creation, and above all the unmediated presence of the God who is Himself their inheritance and their exceeding great reward.

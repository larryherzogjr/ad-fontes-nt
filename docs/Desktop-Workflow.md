...
The active `om-studies-2026-09-11-v6` snapshot is the approved Ad Fontes BSB adaptation of all 250 articles plus the approved full-corpus audit corrections. It preserves the exact v30 adaptation and v5 count-correction provenance, then binds 124 reviewed replacements across 67 articles to candidate SHA-256 `634d06bd89eb99826c5f70ea726a6d7aaca1673558e6f790bfb6312ef8c4d213`. The original website edition remains unchanged. All predecessor releases remain immutable and reproducible.

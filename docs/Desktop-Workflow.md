...
The active `om-studies-2026-09-11-v7` snapshot is the approved Ad Fontes BSB adaptation of all 250 articles plus the approved full-corpus audit corrections and resolution of the five findings previously retained for human/source review. It preserves the exact v30 adaptation, v5 count-correction provenance and v6 audit provenance, then binds the four article corrections and candidate-18 comparison correction to candidate SHA-256 `58cab201852f955de95af4ee2a3531a4f03708e867a0183bc884651a752792d8`. The original website edition remains unchanged. All predecessor releases remain immutable and reproducible.

...
- The final Apple Silicon `1.0.0-rc.1` candidate was built at source `218407e1865b89fc2e9eea5b07dc8082a8517751`. Its app and DMG are Developer ID signed, separately accepted by Apple notarization, stapled and validated; the mounted arm64 app and DMG both pass Gatekeeper as `Notarized Developer ID`. The DMG SHA-256 is `cc235b9b55d3233eb9c5ee28298ae331483f861052d3f86073421279e064f7c5`. The updater archive is signed with the finalized independent updater key. A quarantined clean installation and direct `/Applications` launch passed; served-update rehearsal and exact owner promotion approval remain required before publication.

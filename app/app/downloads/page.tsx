...
const macDownload = 'https://ad-fontes.app/beta-downloads/1.0.0-rc.11/Ad-Fontes-NT-macOS-Apple-Silicon-1.0.0-rc.11.dmg';
const windowsDownload = 'https://ad-fontes.app/beta-downloads/1.0.0-rc.11/Ad-Fontes-NT-Windows-x64-1.0.0-rc.11.exe';

export default function DownloadsPage() {
  return (
    <PublicPage eyebrow="Desktop release candidate" title="Download Ad Fontes NT">
      <p>
        Version 1.0.0-rc.11 brings the Ad Fontes NT reader and study tools to

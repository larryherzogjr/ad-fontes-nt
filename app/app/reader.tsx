      ...
      <main id="reading" ref={main} tabIndex={-1}>
        ...
        {!loading && !error && mode === 'sources' && (
          <section className="sources">
            ...
            <p>Separate Ordinary Means word-study links use the public Greek Word Explorer index from larryherzogjr.com, retrieved September 5, 2026. Links open the original website and preserve its access requirements; article text is not imported.</p>
            <p><a href="/lexical/dodson-2010-v1/manifest.json">Lexicon and word-link source records and checksums</a></p>
